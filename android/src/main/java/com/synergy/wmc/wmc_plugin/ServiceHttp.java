...
public class ServiceHttp {
    ...
    public ServiceHttp(Session sesion) throws MalformedURLException, UnknownHostException {
         ...
         * URL(sesion.getURL()).getHost());
         * 
         * httpclient = new DefaultHttpClient(); //settea usuario y contraseña
         * httpclient.getCredentialsProvider().setCredentials( new
         * AuthScope(address.getHostAddress(), sesion.getPort()), new
         * UsernamePasswordCredentials(sesion.getUsername(), sesion.getPassword()));
         * 
    ...
    public void request(String uri, String method, Map<String, String> options, Object data,
            ResultRequestListener listener) {
        ...
        Log.e("KLK", "client URL" + uri);
        Log.e("KLK", "client OPTIONS" + options);
        Log.e("KLK", "client DATA" + data);
    ...
    private void post(String uri, Map<String, String> options, Object data, ResultRequestListener listener) {
        try {
            ...
            if (data instanceof List) {
                ByteArrayEntity params = new ByteArrayEntity((byte[]) data);
                post.setEntity(params);
            } else if (data instanceof String) {
                StringEntity params = new StringEntity((String) data);
                post.setEntity(params);
            ...
            if (response.getStatusLine().getStatusCode() != 409 // Cuenta inactiva
                ...
                requestResponse = new RequestResponse(new ExceptionObject(E_REQUEST_ERROR, E_REQUEST_ERROR,
                        new Exception("Error request responseCode:" + response.getStatusLine().getStatusCode())));
            }
        } catch (HttpResponseException ht) {
            requestResponse = new RequestResponse(
                    new ExceptionObject(E_HTTP_ERROR, String.valueOf(ht.getStatusCode()), ht));
    ...
    private void get(String uri, Map<String, String> options, Object data, ResultRequestListener listener) {
        ...
        try {
            ...
            Map<String, String> dataTemp = (Map<String, String>) data;
            ...
            if (response.getStatusLine().getStatusCode() != 409 // Cuenta inactiva
                ...
                for (Header key : Arrays.asList(response.getAllHeaders())) {
                    if (key == null)
                        continue;
    ...
    private void put(String uri, Map<String, String> options, Object data, ResultRequestListener listener) {
    ...
    private void delete(String uri, Map<String, String> options, Object data, ResultRequestListener listener) {
    ...
    public void resource(String uri, ResultRequestDataListener listener) {
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                listener.onError(E_REQUEST_ERROR, E_REQUEST_ERROR,
                        new Exception("Error request responseCode:" + response.getStatusLine().getStatusCode()));
            }
        } catch (HttpResponseException ht) {
