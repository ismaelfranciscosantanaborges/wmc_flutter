...
public class ApiWmcModule {
    ...
    public static Session getSession(Context context, String token) {
        try {
            ...
            /*
             * if(latitude == null || latitude.isEmpty()){ latitude = "41.3891"; }
             * if(longitude == null || longitude.isEmpty()){ longitude = "2.1611"; }
             */
            // END Tests simulator
    ...
    public static void request(Context context, String uri, String method, Map<String, String> options,
            Object data, ResultRequestListener listener) {
    ...
    /**
     * Método que proporciona la información de mcc, mnc y unique del la sim del
     * dispositivo.
     * 
     * @param context
     */
    private static void getInfoSim(Context context) {
        ...
        System.out.println("klk: checkSelfPermission READ_PHONE_STATE");
        Log.e("klk", "checkSelfPermission " + Manifest.permission.READ_PHONE_STATE);
        if (ActivityCompat.checkSelfPermission(context,
        Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        System.out.println("klk: havePermission" );
        Log.e("klk", "getInfoSim");

        // obtención de informacion de sim del dispositivo
        TelephonyManager tel = (TelephonyManager) context.getSystemService(context.TELEPHONY_SERVICE);
        String networkOperator = tel.getSimOperator();
        Log.e("klk", "networkOperator" + networkOperator);
    ...
    private static void setDetailDevice() { // detalle de dispositivo
        ...
        appid = "com.synergy.wmc.wmc_plugin"; // appid de la aplicación
        app_Version = "2.0.2"; // versión de la aplicación
